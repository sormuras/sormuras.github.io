...
The Bach.java Intro Series describes how [Bach.java](https://github.com/sormuras/bach) builds a modular Java project.
...
They will build upon this one and only refer to IDEA-related instructions covered in this blog post.
