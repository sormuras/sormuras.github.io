...
This blog describes how [Bach.java](https://github.com/sormuras/bach) builds a modular Java project.
...
This initial introduction prepares the foundation for more blog post to come.
They will build upon this one and only refer to IDEA-related instructions already covered in this blog post.

Without further a do, let's get hacking!
...
IDEA created an initial project structure for us.
